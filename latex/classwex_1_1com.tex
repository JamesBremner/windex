...
\item 
void \mbox{\hyperlink{classwex_1_1com_ac6c2c11ba3bde6a12fb6b95ad21fc7ad}{device\+Input\+Buffer}} (int length)
\begin{DoxyCompactList}\small\item\em set device input buffer length \end{DoxyCompactList}\end{DoxyCompactItemize}
\end{Indent}
...
baud=1200 parity=N data=8 stop=1 \mbox{\Hypertarget{classwex_1_1com_ac6c2c11ba3bde6a12fb6b95ad21fc7ad}\label{classwex_1_1com_ac6c2c11ba3bde6a12fb6b95ad21fc7ad}} 
\index{wex::com@{wex::com}!deviceInputBuffer@{deviceInputBuffer}}
\index{deviceInputBuffer@{deviceInputBuffer}!wex::com@{wex::com}}
\doxysubsubsection{\texorpdfstring{deviceInputBuffer()}{deviceInputBuffer()}}
{\footnotesize\ttfamily void wex\+::com\+::device\+Input\+Buffer (\begin{DoxyParamCaption}\item[{int}]{length }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\em length} & output buffer remains at defualt ( 4K ) This must be called before the call to open \\
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classwex_1_1com_a91bba49affba4cebbd3097667934878c}\label{classwex_1_1com_a91bba49affba4cebbd3097667934878c}} 
