...
void choiceDemo()
{
    ...
    list& listbox = wex::make<list>( form );
...
//    pg.string( "O", "4600" );
    ...
    propertyGrid& pg2 = wex::make<propertyGrid>( form );
...
int main()
{
    ...
    button& btndrop = wex::make<button>( l );
    btndrop.size(  150, 30 );
    ...
    button& btntabs = wex::make<button>( l );
    btntabs.size(  150, 30 );
